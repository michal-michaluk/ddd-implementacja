...
public class IntervalRulesFixture {
    ...
    public static IntervalRules intervalRules() {
        return new IntervalRules(
                ...
                List.of(
                        new IntervalRules.ModelRule(120, "ChargeStorm AB", Pattern.compile("Chargestorm Connected"), null),
                        new IntervalRules.ModelRule(90, "Alfen BV", Pattern.compile("NG920-5250[6-9]"), Pattern.compile("1\\.1")),
                        new IntervalRules.ModelRule(60, "Alfen BV", Pattern.compile("NG920-5250[6-9]"), null)),
                1800);
    }
